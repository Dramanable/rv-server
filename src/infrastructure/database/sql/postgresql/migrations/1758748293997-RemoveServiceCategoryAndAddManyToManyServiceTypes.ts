...
export class RemoveServiceCategoryAndAddManyToManyServiceTypes1758748293997
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    console.log('🔄 Début de la migration RemoveServiceCategory...');
    ...
    await queryRunner.query(`
      INSERT INTO "${schema}"."service_types" (id, business_id, name, code, description, is_active, sort_order, created_at, updated_at)
      SELECT 
        gen_random_uuid(),
        b.id,
        'General Services',
