...
export class CalendarTypeUtils {
  ...
  private static readonly DESCRIPTIONS: Record<CalendarType, string> = {
    [CalendarType.STAFF]:
      'Individual staff member schedules with personal working hours and preferences',
    [CalendarType.BUSINESS]:
      'General business appointments not tied to specific staff members',
    [CalendarType.RESOURCE]:
      'Physical resources like equipment, rooms, or facilities that can be booked',
    [CalendarType.DEPARTMENT]:
      'Team-based calendars for departmental scheduling and coordination',
    [CalendarType.SERVICE]:
      'Specialized calendars for specific services or treatment types',
    [CalendarType.LOCATION]:
      'Location-based calendars for multi-site business management',
  };
   ...
   */
  private static readonly PERMISSION_REQUIREMENTS: Record<
    CalendarType,
    string[]
  > = {
