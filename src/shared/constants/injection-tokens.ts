...
export const APPLICATION_TOKENS = {
  ...
  CREATE_PROFESSIONAL_ROLE_USE_CASE: 'CreateProfessionalRoleUseCase',
  GET_PROFESSIONAL_ROLE_USE_CASE: 'GetProfessionalRoleUseCase',
  LIST_PROFESSIONAL_ROLES_USE_CASE: 'ListProfessionalRolesUseCase',
  UPDATE_PROFESSIONAL_ROLE_USE_CASE: 'UpdateProfessionalRoleUseCase',
  DELETE_PROFESSIONAL_ROLE_USE_CASE: 'DeleteProfessionalRoleUseCase',
