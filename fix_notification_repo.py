...
filepath = 'src/infrastructure/database/sql/postgresql/repositories/typeorm-notification.repository.ts'
...
print('typeorm-notification.repository.ts traité - 2 violations corrigées')
